package com.example.wisatajogja.decoration;
...
abstract class BaseLayoutMargin extends RecyclerView.ItemDecoration {
    ...
    private final com.example.wisatajogja.decoration.MarginDelegate marginDelegate;
    ...
    BaseLayoutMargin(int spanCount, @Px int spacing) {
        ...
        this.marginDelegate = new com.example.wisatajogja.decoration.MarginDelegate(spanCount, spacing);
    }
    ...
    com.example.wisatajogja.decoration.MarginDelegate getMarginDelegate() {
